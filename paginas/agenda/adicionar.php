...
<div id="adicionar">
	<form name="form1" action="<?php echo raiz?>servicosbd/adicionaragenda.php" method="POST">
		<div class="col-md-6 item">
			...
			<select name="nome_cliente" class="form_control" id="" required>
			...
			<?php if(!empty($id_cliente)){ ?>
				<input type="hidden" class="form_control" name="id_cliente" value="<?php echo $id_cliente; ?>">
			<?php } ?>
		</div>
		<div class="col-md-2 item">
			...
			<input type="text" class="form_control date data" required name="start" placeholder="__/__/____">
		</div>
		<div class="col-md-2">
			<div class="texto">
				Hora In&iacute;cio: 
			</div>
			<input type="text" class="form_control hora" required name="hr_inicio" placeholder="__:__">
		</div>
		<div class="col-md-2">
			<div class="texto">
				Hora Fim: 
			</div>
			<input type="text" class="form_control hora" required name="hr_fim" placeholder="__:__">
		</div>
		<div class="col-md-6">
			<div class="texto">
				Obs.:
			</div>
			<textarea name="procedimento" class="form_control" placeholder="Informe detalhes"></textarea>
		</div>
		<div class="col-md-2">
			<div class="texto">
				Forma de pagamento:
			</div>
			<select name="forma_pagamento" class="form_control" id="forma_pagamento">
		...
		<div class="col-md-2">
			...
			<select name="status" id="status">
				...
				<option value="Finalizado/Pronto">Finalizado/Pronto</option>
		...
		<div class="col-md-2">
			...
			<input type="text" name="valor" class="form_control" placeholder="R$">
		</div>
